...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Generate teal colors with slight variations
      let hue = 0.5 + (Math.random() - 0.5) * 0.1; // Teal hue range (0.45-0.55)
      let saturation = 0.8 + Math.random() * 0.2; // High saturation (0.8-1.0)
      let value = 0.7 + Math.random() * 0.3; // Bright value (0.7-1.0)
